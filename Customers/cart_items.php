...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li  class="active"><a href="cart_items.php"> &nbsp; <span class='fa fa-cart-plus'></span> Shopping Cart
                ...
                <ul class="nav navbar-nav navbar-right navbar-user">
					...
					<li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class='glyphicon glyphicon-shopping-cart'></span> Total Pricep echo $total; ?> </b></a>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="fa fa-cart-plus"></span> Shopping Cart>
        </div>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo '<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2021 Equipment RentalsRights Reserved |  Design by : RONNY
