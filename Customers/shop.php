        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a href="cart_items.php"> &nbsp; <span class='fa fa-cart-plus'></span> Shopping Carts</a></li>
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> Everything in one stop!!</h3></center>
        </div>
...
$query1=mysqli_connect("localhost:3309","root","");
mysqli_select_db($query1,"equipment-rental");
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</textarea>
           ...
           <a class='fancybox-buttons' href='../Admin/item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['item_name']."'>
					...
					<center><h4> Price: R ".$query2['item_price']." </h4></center>
...
?>
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2021 Equipment Rentals| All Rights Reserved |  Design by : RONNYNY
